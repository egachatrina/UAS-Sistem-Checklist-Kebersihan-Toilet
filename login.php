...
<body style="margin-top: 30px; background-color: darkblue ;">
    <div class="container" style=" background-color: #0d6efd ; width: 70%; padding: 20px; border-radius: 10px;">
        ...
        <form method="POST">
            ...
            <br>
            <div class="submit">
                <button type="submit" name="submit" class="btn" style="background-color: #3CB371; color: #FFFFFF  ;">Login</button>
            </div>
            <div><br><br>
                <p style="color: #FFff;">Belum memiliki akun??</p>
                <a href="tam_login.php" style="color: #ffff; text-decoration : none;">Buat Akun Baru</a>
            </div>
        </form>
    </div>
</body>