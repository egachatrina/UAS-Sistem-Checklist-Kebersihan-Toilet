...
<body style="margin-top: 30px; background-color: darkblue ;">
    <div class="container" style="background-color: #0d6efd; width: 50%; padding: 30px; border-radius : 10px">
        ...
        <div class="main">
            <form method="post" action="tambah.php" enctype="multipart/form-data">
                ...
                <input class="btn" style="background-color: darkblue; color: #FFFFFF;" type="submit" name="submit" value="Simpan">
            </form>
        </div>
    </div>
</body>
